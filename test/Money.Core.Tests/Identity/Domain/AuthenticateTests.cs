...
namespace Money.Core.Tests.Identity
{
  public class AuthenticateTests
  {
    ...
    public async Task AuthenticateFailsWhenAccountIsLocked()
    {
      ...
      var response = await d.Authenticate.Execute(d.Request);
    ...
    private class Dependencies
    {
      ...
      public Dependencies()
      {
        ...
        Authenticate = new Authenticate(UserRepository.Object, PasswordValidator.Object);
      }
    }
  }
}